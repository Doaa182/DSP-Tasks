...
def AddSignalSamplesAreEqual(userFirstSignal,userSecondSignal,Your_indices,Your_samples):
    if(userFirstSignal=='Signal1.txt' and userSecondSignal=='Signal2.txt'):
        file_name="Task 2 Test Cases\output signals\Signal1+signal2.txt" # write here path of signal1+signal2
    elif(userFirstSignal=='Signal1.txt' and userSecondSignal=='Signal3.txt'):
        file_name="Task 2 Test Cases\output signals\signal1+signal3.txt" # write here path of signal1+signal3
...
def NormalizeSignal(MinRange,MaxRange,Your_indices,Your_samples):
    if(MinRange==-1 and MaxRange==1):
        file_name="Task 2 Test Cases\output signals\normalize of signal 1 -- output.txt" # write here path of normalize signal 1 output.txt
    elif(MinRange==-1 and MaxRange==1):
        file_name="Task 2 Test Cases\output signals\normlize signal 2 -- output.txt" # write here path of normalize signal 2 output.txt
...
def MultiplySignalByConst(User_Const,Your_indices,Your_samples):
    if(User_Const==5):
        file_name="Task 2 Test Cases\output signals\MultiplySignalByConstant-Signal1 - by 5.txt" # write here path of MultiplySignalByConstant-Signal1 - by 5.txt
    elif(User_Const==10):
        file_name="Task 2 Test Cases\output signals\MultiplySignalByConstant-signal2 - by 10.txt" # write here path of MultiplySignalByConstant-Signal2 - by 10.txt
...
def ShiftSignalByConst(Shift_value,Your_indices,Your_samples):
    if(Shift_value==500):
        file_name="Task 2 Test Cases\output shifting by add 500.txt" # write here path of output shifting by add 500.txt
    elif(Shift_value==-500):
        file_name="Task 2 Test Cases\output shifting by minus 500.txt" # write here path of output shifting by minus 500.txt
