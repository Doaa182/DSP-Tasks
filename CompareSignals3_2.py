...
#         print('lenght of my IntervalIndices ',len(Your_IntervalIndices),'lenght of IntervalIndices ',len(expectedIntervalIndices) )
        # print( 'lenght of  my IEncodedValues ',len(Your_EncodedValues), 'lenght of  IEncodedValues ',len(expectedEncodedValues))
#         print(  'lenght of my _QuantizedValues ',len(Your_QuantizedValues),'lenght of  _QuantizedValues ',len(expectedQuantizedValues))
        
        # print('lenght of my Your_SampledError ',len(Your_SampledError),'lenght of  _SampledError ',len(expectedSampledError))        
    ...
    for i in range(len(expectedQuantizedValues)):
        if abs(Your_QuantizedValues[i] - expectedQuantizedValues[i]) < 0.01:
            # print('index ',i,' expected ',expectedQuantizedValues[i] ,'my value is ',Your_QuantizedValues[i])
            continue
        else:
            # print('index ',i,' expected ',expectedQuantizedValues[i] ,'my value is ',Your_QuantizedValues[i])
